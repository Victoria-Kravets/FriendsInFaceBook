...
class ResultSpec: QuickSpec {
    override func spec() {
        ...
        let result = Result(value: value, error: error, default: defaultError)
        ...
        describe("Result") {
            describe("properties") {
                ...
                it("should contain error, when .failure") {
            ...
            describe("mapError"){
                ...
                it("error should be Error.unknown and value is equal nil"){
